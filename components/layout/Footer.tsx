        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold">TutorConnect</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/search" className="text-gray-300 hover:text-white">Find Tutors</Link></li>
              <li><Link href="/auth/student/register" className="text-gray-300 hover:text-white">Sign Up</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/auth/tutor/register" className="text-gray-300 hover:text-white">Become a Tutor</Link></li>
